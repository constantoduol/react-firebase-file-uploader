  ...
  _createClass(FirebaseFileUploader, [{
    ...
    value: function startUpload(file) {
      ...
      var _props = this.props,
          ...
          onBeforeUpload = _props.onBeforeUpload;


      if (onBeforeUpload && typeof onBeforeUpload === 'function') {
        var shouldProceedWithUpload = onBeforeUpload(file);
      ...
      Promise.resolve().then(function () {
        ...
        task.on('state_changed', function (snapshot) {
          ...
          return _this2.props.onUploadSuccess && _this2.props.onUploadSuccess(task.snapshot.metadata.name, task);
        });
